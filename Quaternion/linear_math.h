...
struct Float2
{
	...
	__host__ __device__ Float2(const Float2& v)    : x(v.x), y(v.y) {}
...
struct Float3
{
	...
	__host__ __device__ Float3(const Float3& v)              : x(v.x), y(v.y), z(v.z) {}
...
struct Int3
{
	...
	__host__ __device__ Int3(const Int3& v) : x(v.x), y(v.y), z(v.z) {}
